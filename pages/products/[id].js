...
const Product = ({ product }) => {
  ...
  return (
    <div className="productDetails">
      ...
      <Hero title={product.name} image="ourproducts.webp" />
      <Row justify="center">
        <Col span={16}>
            ...
            <Col xs={24} xl={8}>
              <div className="productPrice">
                <ul>
                  ...
                  <li>
                    <input
                      onChange={(e) => renderPrice(e)}
                      className={product.price_type === "/pc" ? "hidden" : ""}
                      type="number"
                      name="weight"
                      id="inputWeight"
                    ...
                    <input
                      onChange={(e) => renderPrice(e)}
                      className={product.price_type === "/kg" ? "hidden" : ""}
                      type="number"
                      name="numberOfPieces"
                      id="inoutNumberOfPieces"
      ...
      <div className="productInfos">
        <Row justify="center">
          <Section title="Descriptif" icon="fi-rr-document" />
        </Row>
        <Row justify="center">
          <Col span={14}>
        ...
        <Row justify="center">
          <Col span={14}>
            <p>
              {product.allergenes.lenght == 0
                ? "Ce produit contient les allergènes suivant : "
                : "Ce produit ne contient aucun des 14 allergènes (conformément au Règlement (UE) n° 1169/2011 concernant l'information des consommateurs sur les denrées alimentaires) selon la recette. La contamination croisée dans la boucherie ne peut jamais être totalement exclue)."}
            </p>
          </Col>
        </Row>
      </div>
